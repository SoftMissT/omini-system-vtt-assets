/* ═══════════════════════════════════════════════════════════════
 * FOLKLORE SKILL: Vórtice Esmeralda
 * User: Boitatá
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: url('modules/omini-system-assets/assets/bg/leather_texture.webp') repeat, #3e2723; border: 2px solid red; padding: 15px; color: #fff8e1; font-family: 'Courier New', monospace;">
                <h2 style="color: red; text-align: center; text-transform: uppercase; border-bottom: 2px dashed #8d6e63;">Vórtice Esmeralda</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #d7ccc8;">Boitatá</div>
                <p style="padding-top: 10px; font-style: italic;">Atmosfera incendiária. Queima quem usa Cosmo.</p>
                <div style="background: #5d4037; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>EFEITO:</strong> <span style="color: #ffcc80;">Burn IC</span>
                </div>
            </div>
        `
    });
    ...
    if ("Vórtice Esmeralda" === "Estrela de Sete Pontas") {
    ...
    // VFX
    const isFire = "Atmosfera incendiária. Queima quem usa Cosmo.".toLowerCase().includes("fogo") || "Atmosfera incendiária. Queima quem usa Cosmo.".toLowerCase().includes("solar");
