/* ═══════════════════════════════════════════════════════════════
 * FOLKLORE SKILL: Escudo de Grafite
 * User: Pajé Cyber
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: url('modules/omini-system-assets/assets/bg/leather_texture.webp') repeat, #3e2723; border: 2px solid blue; padding: 15px; color: #fff8e1; font-family: 'Courier New', monospace;">
                <h2 style="color: blue; text-align: center; text-transform: uppercase; border-bottom: 2px dashed #8d6e63;">Escudo de Grafite</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #d7ccc8;">Pajé Cyber</div>
                <p style="padding-top: 10px; font-style: italic;">Escudo tecnológico instantâneo.</p>
                <div style="background: #5d4037; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>EFEITO:</strong> <span style="color: #ffcc80;">+10 AC</span>
                </div>
            </div>
        `
    });
    ...
    if ("Escudo de Grafite" === "Estrela de Sete Pontas") {
    ...
    // VFX
    const isFire = "Escudo tecnológico instantâneo.".toLowerCase().includes("fogo") || "Escudo tecnológico instantâneo.".toLowerCase().includes("solar");
