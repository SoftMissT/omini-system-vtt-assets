/* ═══════════════════════════════════════════════════════════════
 * FOLKLORE SKILL: Punhal da Realeza
 * User: Maria Bonita
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: url('modules/omini-system-assets/assets/bg/leather_texture.webp') repeat, #3e2723; border: 2px solid orange; padding: 15px; color: #fff8e1; font-family: 'Courier New', monospace;">
                <h2 style="color: orange; text-align: center; text-transform: uppercase; border-bottom: 2px dashed #8d6e63;">Punhal da Realeza</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #d7ccc8;">Maria Bonita</div>
                <p style="padding-top: 10px; font-style: italic;">Corte na garganta. Anti-Regeneração.</p>
                <div style="background: #5d4037; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>EFEITO:</strong> <span style="color: #ffcc80;">8d8 True</span>
                </div>
            </div>
        `
    });
    ...
    if ("Punhal da Realeza" === "Estrela de Sete Pontas") {
    ...
    // VFX
    const isFire = "Corte na garganta. Anti-Regeneração.".toLowerCase().includes("fogo") || "Corte na garganta. Anti-Regeneração.".toLowerCase().includes("solar");
