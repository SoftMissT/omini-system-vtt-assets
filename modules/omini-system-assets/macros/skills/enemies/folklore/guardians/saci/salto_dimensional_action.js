/* ═══════════════════════════════════════════════════════════════
 * FOLKLORE SKILL: Salto Dimensional
 * User: Saci
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: url('modules/omini-system-assets/assets/bg/leather_texture.webp') repeat, #3e2723; border: 2px solid green; padding: 15px; color: #fff8e1; font-family: 'Courier New', monospace;">
                <h2 style="color: green; text-align: center; text-transform: uppercase; border-bottom: 2px dashed #8d6e63;">Salto Dimensional</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #d7ccc8;">Saci</div>
                <p style="padding-top: 10px; font-style: italic;">Vira fumaça e teleporta.</p>
                <div style="background: #5d4037; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>EFEITO:</strong> <span style="color: #ffcc80;">Teleport</span>
                </div>
            </div>
        `
    });
    ...
    if ("Salto Dimensional" === "Estrela de Sete Pontas") {
    ...
    // VFX
    const isFire = "Vira fumaça e teleporta.".toLowerCase().includes("fogo") || "Vira fumaça e teleporta.".toLowerCase().includes("solar");
