/* ═══════════════════════════════════════════════════════════════
 * FOLKLORE SKILL: Redemoinho de Bambu
 * User: Saci
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: url('modules/omini-system-assets/assets/bg/leather_texture.webp') repeat, #3e2723; border: 2px solid green; padding: 15px; color: #fff8e1; font-family: 'Courier New', monospace;">
                <h2 style="color: green; text-align: center; text-transform: uppercase; border-bottom: 2px dashed #8d6e63;">Redemoinho de Bambu</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #d7ccc8;">Saci</div>
                <p style="padding-top: 10px; font-style: italic;">Vórtice de vento. Desorienta.</p>
                <div style="background: #5d4037; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>EFEITO:</strong> <span style="color: #ffcc80;">5d8 Wind</span>
                </div>
            </div>
        `
    });
    ...
    if ("Redemoinho de Bambu" === "Estrela de Sete Pontas") {
    ...
    // VFX
    const isFire = "Vórtice de vento. Desorienta.".toLowerCase().includes("fogo") || "Vórtice de vento. Desorienta.".toLowerCase().includes("solar");
