/* ═══════════════════════════════════════════════════════════════
 * ASGARD SKILL: Dragon Bravest Blizzard
 * User: Siegfried
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #001a1a, #003333); border: 2px solid ice blue; padding: 15px; color: #ccffff;">
                <h2 style="color: ice blue; text-align: center; font-family: 'Orbitron'; text-shadow: 0 0 5px #00ffff;">Dragon Bravest Blizzard</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.8em; color: #66cccc;">Siegfried - Guerreiro Deus</div>
                <p style="border-top: 1px solid #004d4d; padding-top: 10px; font-style: italic;">Vendaval do Dragão. Dois dragões de gelo.</p>
                <div style="background: #002b2b; padding: 5px; text-align: center; margin-top: 10px; border: 1px solid #004d4d;">
                    <strong>EFEITO:</strong> <span style="color: #33ffff;">15d10 + Push</span>
                </div>
            </div>
        `
    });
