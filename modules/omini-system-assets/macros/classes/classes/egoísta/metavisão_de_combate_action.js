/* ═══════════════════════════════════════════════════════════════
 * CLASS FEATURE: Metavisão de Combate
 * Class: Egoísta
 * Type: Meta
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    if ("Metavisão de Combate" === "Metavisão de Combate") {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="${bgStyle} padding: 10px; color: #fff; font-family: 'Courier New', monospace;">
                <h3 style="color: ${borderColor}; text-transform: uppercase; border-bottom: 1px dashed ${borderColor};">Metavisão de Combate</h3>
                <div style="font-size: 0.8em; color: #888;">&lt;SYSTEM_OVERRIDE: Egoísta&gt;</div>
                <p style="margin-top: 10px;">O mundo desacelera. Linhas de intenção. Crítico se isolado.</p>
                <div style="background: rgba(0,255,0,0.1); border: 1px solid ${borderColor}; padding: 5px; text-align: center; margin-top: 10px;">
                    <strong>STATUS:</strong> <span style="color: ${borderColor};">Auto Crit</span>
                </div>
            </div>
        `
    });
