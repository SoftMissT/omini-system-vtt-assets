/* ═══════════════════════════════════════════════════════════════
 * CLASS FEATURE: Sacrifício do Peão
 * Class: Peca Mestra
 * Type: Reaction
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    if ("Sacrifício do Peão" === "Metavisão de Combate") {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="${bgStyle} padding: 10px; color: #fff; font-family: 'Courier New', monospace;">
                <h3 style="color: ${borderColor}; text-transform: uppercase; border-bottom: 1px dashed ${borderColor};">Sacrifício do Peão</h3>
                <div style="font-size: 0.8em; color: #888;">&lt;SYSTEM_OVERRIDE: Peca Mestra&gt;</div>
                <p style="margin-top: 10px;">Transfere dano fatal para um aliado menor.</p>
                <div style="background: rgba(0,255,0,0.1); border: 1px solid ${borderColor}; padding: 5px; text-align: center; margin-top: 10px;">
                    <strong>STATUS:</strong> <span style="color: ${borderColor};">Redirect Dmg</span>
                </div>
            </div>
        `
    });
