/* ═══════════════════════════════════════════════════════════════
 * CLASS FEATURE: Promoção de Peça
 * Class: Peca Mestra
 * Type: Active
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    if ("Promoção de Peça" === "Metavisão de Combate") {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="${bgStyle} padding: 10px; color: #fff; font-family: 'Courier New', monospace;">
                <h3 style="color: ${borderColor}; text-transform: uppercase; border-bottom: 1px dashed ${borderColor};">Promoção de Peça</h3>
                <div style="font-size: 0.8em; color: #888;">&lt;SYSTEM_OVERRIDE: Peca Mestra&gt;</div>
                <p style="margin-top: 10px;">Transforma aliado em Rainha/Bispo/Torre temporariamente.</p>
                <div style="background: rgba(0,255,0,0.1); border: 1px solid ${borderColor}; padding: 5px; text-align: center; margin-top: 10px;">
                    <strong>STATUS:</strong> <span style="color: ${borderColor};">Buff Rank S</span>
                </div>
            </div>
        `
    });
    ...
    if ("Peca Mestra".includes("Baskerville")) vfxFile = "modules/omini-system-assets/assets/vfx/blood_slash.webm";
