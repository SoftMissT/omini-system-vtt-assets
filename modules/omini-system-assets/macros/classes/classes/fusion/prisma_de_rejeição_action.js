/* ═══════════════════════════════════════════════════════════════
 * CLASS FEATURE: Prisma de Rejeição
 * Class: Fusion
 * Type: Reaction
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    if ("Prisma de Rejeição" === "Metavisão de Combate") {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="${bgStyle} padding: 10px; color: #fff; font-family: 'Courier New', monospace;">
                <h3 style="color: ${borderColor}; text-transform: uppercase; border-bottom: 1px dashed ${borderColor};">Prisma de Rejeição</h3>
                <div style="font-size: 0.8em; color: #888;">&lt;SYSTEM_OVERRIDE: Fusion&gt;</div>
                <p style="margin-top: 10px;">Fusão: Escudo Mana + Espelho. Reflexão pura.</p>
                <div style="background: rgba(0,255,0,0.1); border: 1px solid ${borderColor}; padding: 5px; text-align: center; margin-top: 10px;">
                    <strong>STATUS:</strong> <span style="color: ${borderColor};">Reflect 150%</span>
                </div>
            </div>
        `
    });
