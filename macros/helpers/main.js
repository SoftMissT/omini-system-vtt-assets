...
import { RadarPlayerHUD } from "../../macros 2/.claude/worktrees/pedantic-babbage/scripts/radar-player.js";
import { CharacterSheetJJK } from "../../macros 2/.claude/worktrees/pedantic-babbage/scripts/huds/jjk-character-sheet.js";
import { JJKFichaV2 } from "../../macros 2/.claude/worktrees/pedantic-babbage/scripts/huds/jjk-character-sheet-v2.js";
import { AbsoluteDetectionMatrix } from "../radar/absolute-detection-matrix.js";
import { GMControlHUD } from "../radar/radar-gm-control.js";
import { OmniDbLoader } from "../../macros 2/.claude/worktrees/pedantic-babbage/scripts/utils/db-loader.js";
        ...
        onClick: () => {
          ...
          if (actor) new JJKFichaV2(actor).render(true);
            ...
            ui.notifications.warn(
              "Selecione um token ou defina um personagem padrao!",
            );
        },
      });
