/* ═══════════════════════════════════════════════════════════════
 * SKILL: Law of Reversion
 * Signo: ophiuchus
 * Type: Reaction | Custo: 15 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Law of Reversion</h3>
                <p><em>Reverte o dano recebido.</em></p>
                ${rollHtml}
                <div style="margin-top: 5px; font-size: 0.8em; color: #aaa;">Consumo: 15 IC</div>
            </div>
        `
    });
