...
(async () => {
    ...
    const isOffensive = "Global".toLowerCase().includes("action");
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Hypnotherapy</h3>
                <p><em>Cura total e sono profundo.</em></p>
                ${rollHtml}
