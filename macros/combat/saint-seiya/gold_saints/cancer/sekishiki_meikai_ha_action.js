/* ═══════════════════════════════════════════════════════════════
 * SKILL: Sekishiki Meikai Ha
 * Signo: cancer
 * Type: Action | Custo: 10 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Sekishiki Meikai Ha</h3>
                <p><em>Envia a alma para o Yomotsu.</em></p>
                ${rollHtml}
