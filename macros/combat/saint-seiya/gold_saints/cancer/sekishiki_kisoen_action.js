/* ═══════════════════════════════════════════════════════════════
 * SKILL: Sekishiki Kisoen
 * Signo: cancer
 * Type: Reaction | Custo: 8 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    const isOffensive = "Reaction".toLowerCase().includes("action");
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Sekishiki Kisoen</h3>
                <p><em>Chamas demoníacas que queimam energia.</em></p>
                ${rollHtml}
                <div style="margin-top: 5px; font-size: 0.8em; color: #aaa;">Consumo: 8 IC</div>
            </div>
        `
    });
