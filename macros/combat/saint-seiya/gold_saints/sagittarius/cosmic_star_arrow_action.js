/* ═══════════════════════════════════════════════════════════════
 * SKILL: Cosmic Star Arrow
 * Signo: sagittarius
 * Type: Limit | Custo: 20 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    const isOffensive = "Limit".toLowerCase().includes("action");
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Cosmic Star Arrow</h3>
                <p><em>Flecha matadora de deuses.</em></p>
                ${rollHtml}
                <div style="margin-top: 5px; font-size: 0.8em; color: #aaa;">Consumo: 20 IC</div>
            </div>
        `
    });
