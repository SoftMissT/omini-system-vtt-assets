/* ═══════════════════════════════════════════════════════════════
 * SKILL: Infinity Break
 * Signo: sagittarius
 * Type: Action | Custo: 30 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Infinity Break</h3>
                <p><em>Milhões de flechas de luz.</em></p>
                ${rollHtml}
