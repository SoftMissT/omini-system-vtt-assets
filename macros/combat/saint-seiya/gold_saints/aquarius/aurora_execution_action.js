/* ═══════════════════════════════════════════════════════════════
 * SKILL: Aurora Execution
 * Signo: aquarius
 * Type: Action | Custo: 20 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Aurora Execution</h3>
                <p><em>Execução Aurora. Zero Absoluto.</em></p>
                ${rollHtml}
