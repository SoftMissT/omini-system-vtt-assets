/* ═══════════════════════════════════════════════════════════════
 * SKILL: Diamond Dust Ray
 * Signo: aquarius
 * Type: Bonus | Custo: 8 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Diamond Dust Ray</h3>
                <p><em>Pó de diamante teleguiado.</em></p>
                ${rollHtml}
