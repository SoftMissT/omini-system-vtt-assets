/* ═══════════════════════════════════════════════════════════════
 * SKILL: Galaxian Explosion
 * Signo: gemini
 * Type: Action | Custo: 40 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Galaxian Explosion</h3>
                <p><em>Explosão de galáxias. Dano Verdadeiro.</em></p>
                ${rollHtml}
                <div style="margin-top: 5px; font-size: 0.8em; color: #aaa;">Consumo: 40 IC</div>
            </div>
        `
    });
