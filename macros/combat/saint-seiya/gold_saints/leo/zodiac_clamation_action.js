/* ═══════════════════════════════════════════════════════════════
 * SKILL: Zodiac Clamation
 * Signo: leo
 * Type: Suicide | Custo: 100 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    const isOffensive = "Suicide".toLowerCase().includes("action");
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Zodiac Clamation</h3>
                <p><em>Ataque final suicida.</em></p>
                ${rollHtml}
                <div style="margin-top: 5px; font-size: 0.8em; color: #aaa;">Consumo: 100 IC</div>
            </div>
        `
    });
