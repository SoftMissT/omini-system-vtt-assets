/* ═══════════════════════════════════════════════════════════════
 * SKILL: Lightning Plasma
 * Signo: leo
 * Type: Action | Custo: 15 IC
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: linear-gradient(to bottom, #1a1a1a, #000); border: 2px solid var(--omni-gold); padding: 10px; color: white;">
                <h3 style="color: var(--omni-gold); border-bottom: 1px solid #555;">Lightning Plasma</h3>
                <p><em>Rede de lasers na velocidade da luz.</em></p>
                ${rollHtml}
