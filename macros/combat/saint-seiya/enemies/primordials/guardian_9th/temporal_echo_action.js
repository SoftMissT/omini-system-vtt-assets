/* ═══════════════════════════════════════════════════════════════
 * ENEMY SKILL: Temporal Echo
 * Entity: Guardian 9th (primordials)
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: #050508; border: 2px solid var(--omni-red); padding: 15px; color: #fff;">
                <h2 style="color: var(--omni-red); font-family: 'Orbitron'; text-align: center; margin-bottom: 5px;">Temporal Echo</h2>
                <div style="text-align: center; font-size: 0.8em; color: #666; margin-bottom: 10px;">Guardian 9th - primordials</div>
                <p style="font-style: italic; color: #ccc;">Dano se repete por 3 turnos.</p>
