/* ═══════════════════════════════════════════════════════════════
 * ENEMY SKILL: Zero Hour Erasure
 * Entity: Guardian 12th (primordials)
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: #050508; border: 2px solid var(--omni-red); padding: 15px; color: #fff;">
                <h2 style="color: var(--omni-red); font-family: 'Orbitron'; text-align: center; margin-bottom: 5px;">Zero Hour Erasure</h2>
                <div style="text-align: center; font-size: 0.8em; color: #666; margin-bottom: 10px;">Guardian 12th - primordials</div>
                <p style="font-style: italic; color: #ccc;">Reset total. Apaga memórias e recursos.</p>
