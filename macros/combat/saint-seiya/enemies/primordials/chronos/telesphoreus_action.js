    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: #050508; border: 2px solid var(--omni-red); padding: 15px; color: #fff;">
                <h2 style="color: var(--omni-red); font-family: 'Orbitron'; text-align: center; margin-bottom: 5px;">Telesphoreus</h2>
                <div style="text-align: center; font-size: 0.8em; color: #666; margin-bottom: 10px;">Chronos - primordials</div>
                <p style="font-style: italic; color: #ccc;">Aprisiona o atacante em um loop temporal de morte.</p>
