/* ═══════════════════════════════════════════════════════════════
 * VILLAIN SKILL: Chrono Destruction
 * User: Hyperion
 * ═══════════════════════════════════════════════════════════════ */
(async () => {
    ...
    ChatMessage.create({
        ...
        content: `
            <div style="background: #000; border: 2px solid gold; padding: 15px; color: #fff; font-family: 'Rajdhani';">
                <h2 style="color: gold; text-align: center; font-family: 'Orbitron'; letter-spacing: 2px;">Chrono Destruction</h2>
                <div style="text-align: center; margin-bottom: 10px; font-size: 0.9em; opacity: 0.8;">Hyperion</div>
                <p style="border-top: 1px solid #333; padding-top: 10px;">Petrifica o alvo no tempo.</p>
                <div style="background: #222; padding: 5px; text-align: center; margin-top: 10px; border-radius: 4px;">
                    <strong>DANO:</strong> <span style="color: #ff2b4a;">Petrify</span>
                </div>
            </div>
        `
    });
    ...
    // VFX
    const isTime = "Petrifica o alvo no tempo.".toLowerCase().includes("tempo") || "Petrifica o alvo no tempo.".toLowerCase().includes("time");
