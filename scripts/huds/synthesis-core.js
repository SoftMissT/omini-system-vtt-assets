...
export class SynthesisCore extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        ...
        inventory: {
            template: "modules/omini-system-vtt/templates/huds/parts/synthesis-inventory.hbs"
        }
    };
    ...
    async _prepareContext(options) {
        ...
        return {
            ...
            inventory: actor.items.filter(i => ["weapon", "armor", "consumable"].includes(i.type)) // Context for inventory part
        };
    }
